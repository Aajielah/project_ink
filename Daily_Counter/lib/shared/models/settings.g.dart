...
const SettingsSchema = CollectionSchema(
  ...
  properties: {
    r'backupVersion': PropertySchema(
      id: 0,
      name: r'backupVersion',
      type: IsarType.long,
    ),
...
void _settingsSerialize(
  ...
  writer.writeLong(offsets[0], object.backupVersion);
...
Settings _settingsDeserialize(
  ...
  object.backupVersion = reader.readLong(offsets[0]);
  object.id = id;
...
extension SettingsQueryFilter
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> backupVersionEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'backupVersion',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> backupVersionLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> backupVersionBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> reminderTimeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> reminderTimeLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> reminderTimeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension SettingsQuerySortBy on QueryBuilder<Settings, Settings, QSortBy> {
  QueryBuilder<Settings, Settings, QAfterSortBy> sortByBackupVersion() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backupVersion', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> sortByBackupVersionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backupVersion', Sort.desc);
    });
  }
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> sortByReminderTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminderTime', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> sortByReminderTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsQuerySortThenBy
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> thenByBackupVersion() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backupVersion', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> thenByBackupVersionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backupVersion', Sort.desc);
    });
  }
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> thenByReminderTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminderTime', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> thenByReminderTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminderTime', Sort.desc);
    });
  }
...
extension SettingsQueryWhereDistinct
  ...
  QueryBuilder<Settings, Settings, QDistinct> distinctByBackupVersion() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'backupVersion');
    });
  }
  ...
  QueryBuilder<Settings, Settings, QDistinct> distinctByReminderTime() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsQueryProperty
  ...
  QueryBuilder<Settings, int, QQueryOperations> backupVersionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'backupVersion');
    });
  }
  ...
  QueryBuilder<Settings, DateTime, QQueryOperations> reminderTimeProperty() {
    return QueryBuilder.apply(this, (query) {
